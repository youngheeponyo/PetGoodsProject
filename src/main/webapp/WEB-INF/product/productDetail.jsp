            ...
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="d-flex">
                            <input id="inputQuantity" type="number" pattern="[0-9]*" style="margin:5px;padding:5px;border-radius: 5px;" data-hook="number-input-spinner-input" aria-label="Quantity" max="99999" min="1" value="1">
						...
						<div class="col mb-5">
							<div class="card h-100">
								...
								<img class="card-img-top"
									src="productImage/${petType }/${vo.productImage }"
									alt="..." />
								<!-- Product details-->
								...
								<div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
									<div class="text-center">
										<a class="btn btn-outline-dark mt-auto" href="detailProduct.do?pno=${vo.productNo }">자세히 보기</a>
									</div>
								</div>
							</div>
						</div>
